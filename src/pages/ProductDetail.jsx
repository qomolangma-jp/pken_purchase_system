              ...
              <div className="w-full md:flex-1 flex flex-col justify-center min-w-0 px-4 sm:px-0">
                ...
                <div className="mb-6 flex justify-end md:justify-start">
                  <div className="flex items-baseline gap-1 md:gap-3 bg-transparent md:bg-gradient-to-br md:from-green-50 md:via-emerald-50 md:to-teal-50 md:p-6 md:rounded-2xl md:border-2 md:border-mos-green md:shadow-md">
                    <span className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black text-mos-green">
                      ¥{product.price ? product.price.toLocaleString() : '-'}
                    </span>
                    <span className="text-sm sm:text-base md:text-lg lg:text-xl text-stone-600 font-semibold">税込</span>
                  </div>
                </div>
