            ...
            <nav className="flex-1 flex flex-col p-4 overflow-y-auto">
              <div className="space-y-2">
                ...
                <Link 
                  ...
                  onClick={() => setIsMenuOpen(false)}
                >
                  <span className="inline-flex h-5 w-5 items-center justify-center rounded-full bg-white text-[13px] leading-none font-black text-stone-900 ring-2 ring-stone-900">P</span>
                  <span>ポイント申請</span>
                </Link>
                <Link 
                  to="/news" 
